...
export const SERVICES = [
  {
    ...
    description:
      "High Side & Low Side solutions including Chiller, Heat Pumps, AHUs, and Dehumidifiers.",
    icon: Wind,
    details: [
      "Cooling Towers",
      "Mechanical Piping",
  ...
  },
  {
    ...
    description:
      "Ensuring compliance with industry standards through advanced filtration and durable construction.",
    icon: Layers,
    details: [
      "PPGI/PCGI Puff Panels",
      "Rockwool Panels",
      "Clean Room Doors",
      "Epoxy Flooring",
    ],
  },
  {
    ...
    description:
      "Highly integrated systems for energy efficiency and maintainability.",
    icon: Building2,
    details: [
      "Room Automation",
      "Lighting Control",
  ...
  },
  {
    ...
    description:
      "Automated systems design, energy conservation, and robust safety measures.",
    icon: Zap,
    details: [
      "HT & LT Panels",
      "Cable Laying",
  ...
  },
  {
    ...
    description:
      "Smart infrastructure with high-precision sensor technology and door interlocking.",
    icon: Cpu,
    details: [
      "Face Recognition",
      "Sensor Displays",
  ...
  },
  {
    ...
    description:
      "Customized SS equipment and furniture designed per customer requirements and regulatory compliance.",
    icon: Package,
    details: [
      "Apron Cabinets",
      "Pass Boxes",
      "RLAF & LAF",
      "Storage Tanks & Mixers",
    ],
  },
];
...
export const SLIDES = [
  {
    ...
    subtitle:
      "Manufacturer, Supplier & Exporter of advanced space optimization solutions.",
    description:
      "We are Manufacturer, Supplier, Exporter of Motorized Mobile Storage Systems, Mobile Racking Systems, Mobile Compactors. With ability to store as high as 150 tons in a single mobile unit, this products leaves others far behind in space optimization.",
  ...
  },
  {
    ...
    subtitle:
      "Devoted to the Pharma Industry with turnkey solutions from design to validation.",
    description:
      "Our pharma engineering team provides start-to-finish solutions including custom designing, manufacturing, and complete validation of critical pharmaceutical equipment.",
  ...
  },
  {
    ...
    subtitle:
      "Providing robust and sustainable foundations for diverse pharmaceutical projects.",
    description:
      "We deliver turnkey clean room and HVAC solutions with unparalleled standards, focusing on rigorous particulate control and consistent thermal management for critical environments.",
    image:
  ...
  },
  {
    ...
    subtitle:
      "High precision monitoring for humidity, temperature, and differential pressure.",
    description:
      "Equip your facility with state-of-the-art sensors that provide real-time, high-precision monitoring of environmental variables seamlessly integrated with your control systems.",
    image:
  ...
  },
  {
    ...
    subtitle:
      "Seamless integration of HVAC, Lighting, and Access Control via L-WEB systems.",
    description:
      "Our integrated Building Management Systems centralize control of HVAC, lighting, and security to maximize energy efficiency and operational simplicity.",
    image:
      "https://images.unsplash.com/photo-1558444479-c84825927ad3?q=80&w=2070&auto=format&fit=crop",
    cta: "Technology",
  },
  {
    id: 7,
    ...
    subtitle:
      "Empowering technological support for Nepal's growing industrial sector.",
    description:
      "We provide innovative and robust industrial control mechanisms specifically tailored to support and advance the rapidly growing industrial sector in Nepal.",
    image:
