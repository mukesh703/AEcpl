    ...
    <div className="pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-10 py-24">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="text-lg text-slate-600 font-sans leading-relaxed space-y-4">
                  <p>
                    Since our inception, Aditya Engineering & Consultancy has
                    been driven by a singular vision: to empower the industrial
                    landscape of Nepal with world-class engineering solutions.
                    We believe that efficiency is not just a metric, but a
                    cornerstone of sustainable growth.
                  </p>
                  <p>
                    By integrating innovative BMS technologies and
                    pharmaceutical-grade infrastructure, we are not just
                    building facilities; we are building the future of
                    self-reliance for our nation.
                  </p>
                </div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32">
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-lg text-slate-600 font-sans leading-relaxed">
              <p>
                Established in 2018, Aditya Engineering & Consultancy has
                rapidly become a trusted partner for the pharmaceutical
                industry. We simplify complex engineering challenges through a
                unified approach to design and automation.
              </p>
              <div className="p-10 bg-slate-900 text-white rounded-[2rem] shadow-2xl relative overflow-hidden">
                ...
                <p className="italic font-medium leading-relaxed relative z-10">
                  "Our goal is to deliver world-class engineering solutions that
                  empower local industries to thrive on a global scale."
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-32 text-center">
          <div className="max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-slate-500 font-sans text-lg">
              Delivering quality and excellence to companies that rely on our
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-8">
            {INDUSTRY_LEADERS.map((leader, idx) => (
              ...
              >
                <img
                  src={
                    leader.logo.startsWith("./")
                      ? import.meta.env.BASE_URL + leader.logo.substring(2)
                      : leader.logo
                  }
                  alt={leader.name}
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src =
                      `https://ui-avatars.com/api/?name=${encodeURIComponent(leader.name)}&background=f1f5f9&color=1b3281&font-size=0.33&length=2`;
                  }}
                />
              </motion.div>
            ))}
        ...
        <section className="mb-32 text-center">
          <div className="max-w-3xl mx-auto mb-16 space-y-4">
            <h3 className="text-3xl md:text-5xl font-bold text-slate-900">
              Other Industries Client
            </h3>
            <p className="text-slate-500 font-sans text-lg">
              Proudly extending our expertise to a diverse range of industries.
            </p>
          </div>
                ...
                <img
                  src={
                    client.logo.startsWith("./")
                      ? import.meta.env.BASE_URL + client.logo.substring(2)
                      : client.logo
                  }
                  alt={client.name}
                  className="max-h-16 max-w-full object-contain transition-all duration-500 hover:scale-110"
                  onError={(e) => {
                    (e.target as HTMLImageElement).src =
                      `https://ui-avatars.com/api/?name=${encodeURIComponent(client.name)}&background=f1f5f9&color=1b3281&font-size=0.33&length=2`;
                  }}
                />
              </motion.div>
            ))}
        ...
        <section className="mb-32">
          <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
            <h2 className="text-primary text-xs font-bold uppercase tracking-[0.3em]">
              Our Professionals
            </h2>
            <h3 className="text-3xl md:text-5xl font-bold text-slate-900">
            ...
            <p className="text-slate-500 font-sans text-lg">
              Our multi-disciplinary team of engineers and consultants work
              together to deliver precision at every scale.
            </p>
          </div>
